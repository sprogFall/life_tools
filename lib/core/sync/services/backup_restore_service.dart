...
///
/// 设计原则：
/// - 工具数据/配置走 ToolSyncProvider 的公共接口（与“数据同步”一致）
/// - 同步配置（SyncConfig）由 SyncConfigService 负责保存/加载
class BackupRestoreService {
  ...
  Future<BackupRestoreResult> restoreFromJson(String jsonText) async {
    ...
    final toolsMap = toolsNode is Map ? Map<String, dynamic>.from(toolsNode) : null;
