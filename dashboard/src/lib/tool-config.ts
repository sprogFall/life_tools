    ...
    sections: [
      {
        key: 'templates',
        label: '拍摄模板',
        description: '维护外拍助手可选模板的名称和排序。',
        idKey: 'id',
        fields: [
          { key: 'id', label: 'ID', type: 'number' },
          { key: 'name', label: '模板名称', type: 'text', placeholder: '如：交付拍摄模板' },
          { key: 'sort_index', label: '排序', type: 'number' },
      ...
      },
      {
        ...
        label: '目录层级',
        description: '维护模板下的目录树，例如楼栋、楼层、房间。',
        idKey: 'id',
        fields: [
          { key: 'id', label: 'ID', type: 'number' },
          { key: 'template_id', label: '所属模板', type: 'number' },
          { key: 'parent_level_id', label: '上级目录', type: 'number', defaultValue: null },
      ...
      },
      {
        key: 'capture_items',
        label: '拍摄项',
        description: '维护需要拍摄的项目、所属目录和张数要求。',
        idKey: 'id',
        fields: [
          { key: 'id', label: 'ID', type: 'number' },
          { key: 'template_id', label: '所属模板', type: 'number' },
          { key: 'parent_level_id', label: '归属目录', type: 'number', defaultValue: null },
          { key: 'name', label: '拍摄项名称', type: 'text' },
          { key: 'sort_index', label: '排序', type: 'number' },
          { key: 'min_count', label: '最少张数', type: 'number' },
          { key: 'max_count', label: '最多张数', type: 'number', defaultValue: null },
          { key: 'is_archived', label: '已归档', type: 'boolean' },
          { key: 'created_at', label: '创建时间', type: 'datetime' },
          { key: 'updated_at', label: '更新时间', type: 'datetime' },
        ],
