...
export const DASHBOARD_PILL_BUTTON_MD =
  `${DASHBOARD_PILL_BUTTON_BASE} min-h-11 px-5 py-2 text-sm font-semibold`;

export const DASHBOARD_PILL_BUTTON_TAB =
  `${DASHBOARD_PILL_BUTTON_BASE} min-h-11 px-4 py-2 text-sm font-medium`;
