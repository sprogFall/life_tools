export default function NotFound() {
  return (
    <div className="rounded-4xl border border-slate-200/80 bg-white/85 px-6 py-16 text-center shadow-panel">
      ...
      <a
        href="/users"
        className="mt-6 inline-flex h-11 items-center justify-center rounded-full bg-brand-700 px-5 text-sm font-semibold text-white transition hover:bg-brand-800"
      >
        返回同步用户目录
      </a>
    </div>
